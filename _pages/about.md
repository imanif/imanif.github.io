...
Previously, I've had the opportunity to work with those from the Johns Hopkins Center for Natural Language Processing, Google, Laboratoire d'Informatique de l'Universtié du Mans (LIUM), and the Brown University Visual Computing Lab. I received my B.A from Cornell University and my [honors thesis](http://imanif.github.io/files/Finkley_HonorsThesis.pdf) examined generative AI's impact on the literary tradition and the future of authorship. 
